...
function RoomPageView({code, players, playerName, isEditing, handlePlayerNameInput, handleSubmitClick, handleEditClick, currentSeason, leaveRoomClick, handleRandomiseClick }) {
    return (
